...
class AlattangkapController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Alattangkap $alat)
    {
        $alattangkap = Alattangkap::where('id_alat', $alat->id_alat)->first();
    ...
    public function update(Request $request, Alattangkap $alattangkap)
    {
        ...
        return Alattangkap::firstWhere('id_alat', $alattangkap->id_alat)->update($fields);
    }
